//
//  LibraryCollectionViewSectionHeaderView.swift
//  MarvelApp
//
...
final class LibraryCollectionViewSectionHeaderView: UICollectionReusableView {
    static let identifier = String(describing: LibraryCollectionViewSectionHeaderView.self)
...
private extension LibraryCollectionViewSectionHeaderView {
    func setupUI() {
