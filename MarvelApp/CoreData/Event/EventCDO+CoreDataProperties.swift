//
//  EventCDO+CoreDataProperties.swift
//  MarvelApp
//
...
extension EventCDO {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<EventCDO> {
        return NSFetchRequest<EventCDO>(entityName: "EventCDO")
    }
...
extension EventCDO : Identifiable {
